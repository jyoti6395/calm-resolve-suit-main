  ...
  return (
    <MobileShell>
      <div className="min-h-screen bg-background pb-24 flex flex-col w-full max-w-md mx-auto">
        ...
        {/* ========================================= */}
        <div className="px-4 mt-4 pb-30 flex flex-col gap-3">
          ...
          {filteredList.length === 0 && (
            <div className="text-center py-12 px-6 flex flex-col items-center justify-center bg-card border border-border rounded-3xl shadow-soft">
