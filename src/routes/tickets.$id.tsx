...
function TicketWorkspace() {
  ...
  const handleSendMessage = async (content: string) => {
    ...
    // Auto-assign to current technician if ticket is unassigned or assigned to someone else
    ...
    try {
      ...
      // Recipient calculation should use the updated assignment state
  ...
  const headerRight = (
    <button className="h-10 w-10 -mr-2 rounded-full hover:bg-muted flex items-center justify-center text-foreground cursor-pointer">
  ...
  return (
    <MobileShell scrollable={false}>
      ...
      <div className="h-full flex flex-col justify-between w-full bg-background">
        ...
        {/* Reusable Message Input Form Component */}
