      ...
      <div className="min-h-screen bg-background flex flex-col items-center px-6 pt-[15vh] pb-10">
        ...
        <div className="mt-auto w-full space-y-3 pt-10">
          <Link
            to="/tickets/$id"
            params={{ id: "AT-2841" }}
            className="flex items-center justify-center gap-2 h-14 rounded-2xl bg-gradient-brand text-primary-foreground font-semibold shadow-elevated"
          >
            View ticket <ArrowRight className="h-4 w-4" />
          </Link>
          <Link
            to="/dashboard"
            className="block text-center h-14 leading-[3.5rem] rounded-2xl bg-secondary font-semibold"
          >
            Back to dashboard
          </Link>
        </div>
