...
const groups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Marco Diaz picked up AT-2839.",
        time: "1h",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Scheduled VPN gateway restart Sat 02:00 UTC.",
        time: "1d",
      },
    ],
  },
...
function Toggle({ on }: { on: boolean }) {
  return (
    <span
      className={`h-6 w-10 rounded-full p-0.5 transition-colors ${on ? "bg-primary" : "bg-muted"}`}
    >
      <span
